...
gemini_config_cell = {
    ...
    "source": [
        ...
        "\n",
        "try:\n",
        "    from lib.gemini_api import list_available_gemini_models, get_gemini_key\n",
        "    \n",
        ...
        "                print(f\"- {display_name} (full name: {model})\")\n",
        "            if not models:\n",
        "                print(\"\\nNo Gemini models found! Using default models.\")\n",
        "                models = [\"models/gemini-pro\", \"models/gemini-1.0-pro\"]\n",
        "        except Exception as e:\n",
...
long_video_cell = {
    ...
    "source": [
        ...
        "import os\n",
        "try:\n",
        "    available_models = os.environ.get(\"AVAILABLE_GEMINI_MODELS\", \"models/gemini-pro,models/gemini-1.0-pro\").split(\",\")\n",
        ...
        "    available_models = [\"models/gemini-pro\", \"models/gemini-1.0-pro\"]\n",
        "    model_options = [\"gemini-pro\", \"gemini-1.0-pro\"]\n",
        "    model_mapping = {\"gemini-pro\": \"models/gemini-pro\", \"gemini-1.0-pro\": \"models/gemini-1.0-pro\"}\n",
        "\n",
